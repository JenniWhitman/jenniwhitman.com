...
const jobs: Job[] = [
  {
    ...
    summary: 'Integrated Eppo’s SDK and Mixpanel into the Marionette/Backbone/React app to track user behavior and optimize the new user experience.',
    details: [
  ...
  },
  {
    ...
    summary: 'Developed and maintained learning resources using Django, Python, React, PostgreSQL, Redis, Docker, and Heroku.',
    details: [
  ...
  },
  {
    ...
    summary: 'Built scalable applications for frontline worker hiring and retention using Python, React, Redux, MySQL, and Redis.',
    details: [
  ...
  },
  {
    ...
    summary: 'Developed an external API, documentation, and integration standards using Django REST framework and OpenAPI.',
    details: [
  ...
  },
  {
    ...
    summary: 'Designed cost-effective, scalable solutions to increase revenue through white-labeling and other strategic enhancements.',
    details: [
  ...
  },
  {
    ...
    summary: 'Developed a custom CMS integrating multiple services into a centralized .com platform using Django and JavaScript.',
    details: [
  ...
  },
  {
    ...
    details: ['Left to pursue a role better aligned with long-term career goals.'],
  },
  {
    title: 'Online Course Developer',
    company: 'InterSystems Corporation',
    range: 'July 2016 – Dec 2017',
    summary: 'Developed online courses teaching application development with InterSystems products.',
    details: [
